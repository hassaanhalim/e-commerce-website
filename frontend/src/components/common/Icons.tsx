      ...
      {Array.from({ length: maxStars }).map((_, idx) => {
        ...
        return (
          <StarIcon
            key={idx}
            filled={isFilled}
            className={`${starClassName} ${isFilled ? "text-amber-400" : "text-gray-200"}`}
          />
        );
      })}
    </div>
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.25V14.25m0-6.75h-7.5a1.125 1.125 0 00-1.125 1.125v6.75m8.625-7.875v-.375a1.125 1.125 0 00-1.125-1.125H3.375A1.125 1.125 0 002.25 6v8.25"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-6-10.5h16.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25H3.75A2.25 2.25 0 011.5 18V8.25A2.25 2.25 0 013.75 6z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.455a20.354 20.354 0 01-1.328-3.693m2.99-9.706A17.95 17.95 0 0112 5.052v13.896c-.61-.097-1.2-.236-1.66-.413M16.5 7.5a4.5 4.5 0 010 9"
      />
    </svg>
  );
}
